...
class Survey_model extends ci_model{
    ...
    var $table = 'survey';
    var $column_order = array(null, 'tanggal_survey','user_id','kpk','kategori_id','nama_nasabah','alamat','sistem_pinjam','jangka','tujuan','usaha','plafon'); //set column field database for datatable orderable
    var $column_search = array('tanggal_survey','nama','nama_nasabah_prospek'); //set column field database for datatable searchable 
    var $order = array('tanggal_survey' => 'desc'); // default order 
    ...
    private function _get_datatables_query()
    {
      ...
      $this->db->join('sistem_pinjam as r', 'r.id_sistem_pinjam = p.sistem_pinjam');
    ...
    private function _get_datatables_querytgluserkantor($tglawal, $tglakhir, $user, $kantor)
    {
      ...
      $this->db->where('p.tanggal_survey >=', $tglawal);
      $this->db->where('p.tanggal_survey <=', $tglakhir);
    ...
    public function count_alltgluserkantor($tglawal, $tglakhir, $user, $kantor)
    {
        ...
        $this->db->where('tanggal_survey >=', $tglawal);
        $this->db->where('tanggal_survey <=', $tglakhir);
    ...
    function data()
    {
        ...
        return $query = $this->db->get('survey');
    }
    ...
    public function dataJoin()
    {
      ...
      $this->db->order_by('p.id_survey','DESC');
      return $query = $this->db->get();
    }
    ...
    public function dataJoinLike($tahun)
    {
      ...
      $this->db->like('p.tanggal_survey', $tahun);
      $this->db->order_by('p.id_survey','DESC');
      return $query = $this->db->get();
    }
    ...
    public function ambilFoto1($where)
    {
      $this->db->order_by('id_survey','DESC');
      $this->db->limit(1);
      $query = $this->db->get_where('survey', $where);   
