        ...
        <div class="col-lg-3 mb-3">        
            <div class="form-group"><label>Marketing</label>
                <select name="user" id="user" class="form-control" onchange="filterTahun()">
                    ...
                    <?php foreach($usermanajer as $j): ?>
                    <option value="<?= $j->id_user ?>"><?= $j->nama ?></option>
                    <?php endforeach ?>
                </select>
            </div>           
        </div>
        <input class="form-control" name="kpk" id="kpk" type="hidden" value="<?= $this->session->userdata('login_session')['kantor_id'] ?>" onchange="filterTahun()">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="row">
                    ...
                    <input class="form-control" name="kpkpie" id="kpkpie" type="hidden" value="<?= $this->session->userdata('login_session')['kantor_id'] ?>" onchange="filterTahunPie()">
...
<script src="<?= base_url(); ?>assets/js/chart/chart-area_manajer.js"></script>
<script src="<?= base_url(); ?>assets/js/chart/pie-chart_manajer.js"></script>
