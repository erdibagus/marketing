...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>nasabah/proses_tambah_teletagih" name="myForm" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            <div class="form-group"><label>No. PMP</label>
                                <input class="form-control" name="no_pmp" type="text" placeholder="">
                            </div>

                            <div class="form-group"><label>Nama Nasabah</label>
                                <input class="form-control" name="nama_nasabah" type="text" placeholder="">
                            </div>
