...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>nasabah_prospek/proses_ubah" name="myForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="d-sm-flex  justify-content-between mb-0">
            <div class="mb-4">
                ...
                <div class="card border-bottom-secondary shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            <input class="form-control" name="id_nasabah_prospek" type="hidden" value="<?= $d->id_nasabah_prospek ?>">

                            <div class="form-group"><label>Nama Nasabah</label>
                                <input class="form-control" name="nama_nasabah_prospek" type="text" value="<?= $d->nama_nasabah_prospek ?>">
                            </div>
                            ...
                            <div class="form-group"><label>No Telepon</label>
                                <input class="form-control" name="no_tlp" value="<?= $d->no_tlp ?>" type="text">
                            </div>
                        </div>
                    </div>
                </div>
