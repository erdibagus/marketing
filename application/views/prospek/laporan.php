...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h5 mb-0 text-center text-uppercase font-weight-bold text-gray-800">Laporan Prospek</h1>
    </div>
    ...
    <div class="mb-4" id="container">
        ...
        <div class="card border-bottom-secondary shadow mb-4">
            <div class="card-body">
                <form action="<?= base_url() ?>laporan/prospek_pdf" method="POST" target="_blank">
                    <div class="row">
    ...
    <div class="mb-4" id="container">
        ...
        <div class="card border-bottom-secondary shadow mb-4">
            <div class="card-body">
                <form action="<?= base_url() ?>laporan/prospek_pdf_manajer" method="POST" target="_blank">
                    <div class="row">
                        <div class="col-lg-3 mb-4">
                            <label>Tanggal</label>
                            <div class="input-group">
...
<script src="<?= base_url(); ?>assets/js/laporan/lap_prospek.js"></script>
