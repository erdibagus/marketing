...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h5 mb-0 text-center text-uppercase font-weight-bold text-gray-800">Scoring</h1>
    </div>
    ...
    <div class="mb-4" id="container">
        ...
        <div class="card border-bottom-secondary shadow mb-4">
            <a href="<?= base_url() ?>scoring/tambah" class="btn btn-sm btn-primary btn-icon-split">
...
var table;  
 $(document).ready(function() {
     ...
     table = $('#tabel').DataTable({ 
         ...
         "ajax": {
             "url": "<?php echo site_url('scoring/ajax_list')?>",
             "type": "POST"
         },
...
var table;  
 $(document).ready(function() {
     ...
     table = $('#tabeluser').DataTable({ 
         ...
         // Load data for the table's content from an Ajax source
         "ajax": {
             "url": "<?php echo site_url('scoring/ajax_list_user')?>",
             "type": "POST"
         },
...
var table;  
 $(document).ready(function() {
     ...
     table = $('#tabelmanajer').DataTable({ 
         ...
         // Load data for the table's content from an Ajax source
         "ajax": {
             "url": "<?php echo site_url('scoring/ajax_list_manajer')?>",
             "type": "POST"
         },
