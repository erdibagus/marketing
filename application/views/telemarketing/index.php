    ...
    <div class="align-items-center justify-content-between">
        <h1 class="h5 mb-0 text-center text-uppercase font-weight-bold text-gray-800">Teleprospek</h1>

    </div>
    
        <!-- Illustrations -->
    <div class="card-body">
        <a href="<?= base_url() ?>telemarketing/tambah" class="col-lg btn btn-sm bg-gradient-info btn-icon-split">
...
var table;
 ...
 $(document).ready(function() {
     ...
     table = $('#tabel').DataTable({ 
         ...
         "ajax": {
             "url": "<?php echo site_url('telemarketing/ajax_list')?>",
             "type": "POST"
         },
...
var table;
 ...
 $(document).ready(function() {
     ...
     table = $('#tabelmanajer').DataTable({ 
         ...
         // Load data for the table's content from an Ajax source
         "ajax": {
             "url": "<?php echo site_url('telemarketing/ajax_list_manajer')?>",
             "type": "POST"
         },
...
var table;
 ...
 $(document).ready(function() {
     ...
     table = $('#tabeluser').DataTable({ 
         ...
         // Load data for the table's content from an Ajax source
         "ajax": {
             "url": "<?php echo site_url('telemarketing/ajax_list_user')?>",
             "type": "POST"
         },
