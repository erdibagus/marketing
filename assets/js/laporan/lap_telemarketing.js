...
function filtertgluserkantor(tglawal, tglakhir, user, kantor) {
    ...
    var base_url = link + 'telemarketing/filtertgluserkantor/' + tglawal + '/' + tglakhir + '/' + user + '/' + kantor + '';
...
function filtertgluser(tglawal, tglakhir, user) {
    var link = $('#baseurl').val();
    var base_url = link + 'telemarketing/filtertgluser/' + tglawal + '/' + tglakhir + '/' + user + '';
...
function filtertglkantor(tglawal, tglakhir, kantor) {
    var link = $('#baseurl').val();
    var base_url = link + 'telemarketing/filtertglkantor/' + tglawal + '/' + tglakhir + '/' + kantor + '';
...
function filtertgl(tglawal, tglakhir) {
    var link = $('#baseurl').val();
    var base_url = link + 'telemarketing/filtertgl/' + tglawal + '/' + tglakhir + '';
...
function filtertglmanajer(tglawal, tglakhir) {
    var link = $('#baseurl').val();
    var base_url = link + 'telemarketing/filtertglmanajer/' + tglawal + '/' + tglakhir + '';
