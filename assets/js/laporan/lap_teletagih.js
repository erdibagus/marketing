...
function filtertgluserkantor(tglawal, tglakhir, user, kantor) {
    ...
    var base_url = link + 'teletagih/filtertgluserkantor/' + tglawal + '/' + tglakhir + '/' + user + '/' + kantor + '';
...
function filtertgluser(tglawal, tglakhir, user) {
    var link = $('#baseurl').val();
    var base_url = link + 'teletagih/filtertgluser/' + tglawal + '/' + tglakhir + '/' + user + '';
...
function filtertglkantor(tglawal, tglakhir, kantor) {
    var link = $('#baseurl').val();
    var base_url = link + 'teletagih/filtertglkantor/' + tglawal + '/' + tglakhir + '/' + kantor + '';
...
function filtertgl(tglawal, tglakhir) {
    var link = $('#baseurl').val();
    var base_url = link + 'teletagih/filtertgl/' + tglawal + '/' + tglakhir + '';
...
function filtertglmanajer(tglawal, tglakhir) {
    var link = $('#baseurl').val();
    var base_url = link + 'teletagih/filtertglmanajer/' + tglawal + '/' + tglakhir + '';
